    ...
    <div className="w-full max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-muted-foreground flex items-center gap-2">
              {t("startLabel")}
              {startDate && startTime && <Check className="h-3.5 w-3.5 text-primary" />}
            </label>
            <div
              className={cn(
              ...
              <Popover open={startDateOpen} onOpenChange={handleStartDateOpenChange}>
                ...
                >
                  ...
                  <span className="font-medium">
                    {startDate ? format(startDate, "EEE d MMM", { locale: dateLocale }) : t("startDate")}
                  </span>
                </PopoverTrigger>
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-muted-foreground flex items-center gap-2">
              {t("endLabel")}
              {endDate && endTime && <Check className="h-3.5 w-3.5 text-primary" />}
            </label>
            <div
              className={cn(
                "flex rounded-lg border-2 transition-all duration-200 overflow-hidden",
            ...
            >
              ...
              <Popover open={endDateOpen} onOpenChange={handleEndDateOpenChange}>
                ...
                >
                  <CalendarIcon className="h-4 w-4 shrink-0" />
                  <span className="font-medium">
                    {endDate ? format(endDate, "EEE d MMM", { locale: dateLocale }) : t("endDate")}
                  </span>
                </PopoverTrigger>
                <PopoverContent className="w-auto p-0" align="start">
                  <Calendar
        ...
        <div className="border-t pt-4">
          <p className="text-xs text-muted-foreground text-center mb-3">{t("quickSelect.title")}</p>
          <div className="flex flex-wrap justify-center gap-2">
            {quickSelectOptions.map((option, index) => (
              <Button key={index} variant="outline" onClick={option.onClick} className="text-xs">
                {option.label}
              </Button>
            ))}
          </div>
