...
interface RepairDowntimeSuggestionState {
  units: Array<{
    id: string;
    identifier: string;
    productName: string;
...
function StepOverview({
  ...
  return (
    <div className="space-y-6">
      {/* Header info */}
      <div className="from-primary/10 via-primary/5 rounded-2xl bg-gradient-to-br to-transparent p-6">
...
function StepSignature({
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="via-blue-25 rounded-2xl bg-gradient-to-br from-blue-50 to-transparent p-6 dark:from-blue-950/50 dark:via-blue-950/25">
        <div className="flex items-center gap-4">
...
export function InspectionWizard({
  ...
  return (
    ...
    <div className="-mx-4 -mt-6 -mb-6 flex min-h-[calc(100dvh-3.5rem)] flex-col sm:-mx-6 lg:-mx-8 lg:min-h-dvh">
      {/* Header */}
