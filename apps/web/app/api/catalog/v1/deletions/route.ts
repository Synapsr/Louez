import { ApiServiceError, listTombstones } from "@louez/api/services";
import { catalogDeletionsRouteQuerySchema } from "@louez/validations";
...
const handleGet = async (request: NextRequest) => {
  ...
  try {
    ...
    const parsed = catalogDeletionsRouteQuerySchema.safeParse({
    ...
    logger.error(error instanceof Error ? error : new Error("Catalog deletions request failed"));
