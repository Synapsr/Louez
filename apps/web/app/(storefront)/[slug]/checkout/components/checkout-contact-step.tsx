...
import { Button, Collapsible, CollapsiblePanel, CollapsibleTrigger, StepContent } from "@louez/ui";
...
export const CheckoutContactStep = withForm({
  ...
  render: ({
    ...
    return (
      <>
        <StepContent className="flex flex-col gap-4" direction={stepDirection}>
