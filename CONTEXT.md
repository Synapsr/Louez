...
- The existing Tulip integration stores legacy state inside **Store** settings; resolved: migrated integrations use dedicated integration records while compatibility code reads legacy settings during transition.
