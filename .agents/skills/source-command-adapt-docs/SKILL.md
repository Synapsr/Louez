---
name: "source-command-adapt-docs"
...
# source-command-adapt-docs

Use this skill when the user asks to run the migrated source command `adapt-docs`.
...
- `AGENTS.md` only if it contains tech-specific content (it usually just points at `AGENTS.md`)
