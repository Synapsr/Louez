...
| Suivi        | pending, confirmed, ongoing, completed, cancelled, rejected, quote, declined ; timeline, devis, contrat, téléchargement calendrier, changement de dates et prolongation | `packages/db/src/schema.ts`, `lib/reservations/util.reservation-actions.ts`, `extension-service.ts`                          |
| Caution      | none, pending, card_saved, authorized, captured, released, failed                                                                                                       | `packages/db/src/schema.ts`, `lib/reservations/util.payment-status.ts`, route `authorize-deposit`                            |
